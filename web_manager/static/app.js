...
function buildChip(label, value, count = null) {
  ...
  if (count === null) {
    ...
    button.append(nameText, countText);
  }
...
function renderCategoryChips() {
  ...
  state.categories.forEach((category) => {
    elements.chips.appendChild(buildChip(category.name, category.name, category.count));
  });
